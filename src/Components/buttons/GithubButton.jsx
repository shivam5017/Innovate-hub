...
const GithubBtn = () => {
  return (
    <button
      ...
      className="relative p-1.5 md:p-3 flex font-semibold text-sm text-text border-accent items-center gap-3 rounded-full  transition-all shadow-[0_0_15px_rgba(0,255,0,0.5)]"
    >
      <GitHubIcon />
      <h4 className="text-sm hidden md:block ">GitHub</h4>
    </button>
  );
};
