...
const TeamPage = () => {
  ...
  return (
    <section id="team" className="py-8 container pt-24">
      <h2 className="text-2xl lg:text-3xl font-bold text-center font-primary">
        Meet the Team
      </h2>
        ...
        {loading
          ...
          : teamMembers.map((member, index) => (
              <div key={index} className="rounded-lg shadow-md p-4 text-center">
                ...
                <h3 className="text-sm lg:text-xl font-semibold font-primary">
                  {member?.name}
                </h3>
                <h4 className="text-sm text-lightText font-paragraph">
                  {member?.position}
                </h4>
                <p className="mt-2 text-lightText text-sm font-paragraph">
                  {member?.bio}
                </p>
                <div className="flex gap-5 mt-10">
                  {member.github && (
                  ...
                  {member.linkedIn && (
                    <CustomBtnWithIcon
                      text="LinkedIn"
                      icon={<LinkedIn aria-hidden="true" />} // Ensure the icon is hidden from screen readers
